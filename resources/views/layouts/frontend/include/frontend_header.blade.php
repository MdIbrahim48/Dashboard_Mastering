            ...
            <div class="header-wrap header-space-between position-relative">
                ...
                <div class="header-nav d-none d-lg-flex">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            <ul>
                                <li class="hot-deals"><img src="{{ asset('frontend_assets') }}/imgs/theme/icons/icon-hot-white.svg" alt="hot deals" /><a href="shop-grid-right.html">Hot Deals</a></li>
                                <li>
                ...
                <div class="hotline d-none d-lg-flex">
                    ...
                    <p><a href="tel:+01917364532" style="color: white;">01917364532</a><span>24/7 Support Center</span></p>
                </div>
